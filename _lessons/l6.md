...
OpenLayers ci permette di gestire dati WMTS in modo semplice utilizzado la sorgente [**ol.source.WMTS**](https://openlayers.org/en/latest/apidoc/module-ol_source_WMTS-WMTS.html) per il layer **ol.layer.Tile** specificando:

* **url**: L'url del servizio

* **layer**: Il layer associato

* **version**: La versione del servizio WMTS (default 1.0.0)

* **projection**: La proiezione del layer (di default viene presa quella della View)

[**Esempio**](https://openlayers.org/en/latest/examples/wmts.html)
